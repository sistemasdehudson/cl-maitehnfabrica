...
class AuthSignupHome(odoo.addons.web.controllers.main.Home):
    ...
    def web_login(self, *args, **kw):
        ...
        if request.httprequest.method == 'POST' and user.seller and user.sudo().has_group('odoo_marketplace.marketplace_draft_seller_group') and not user.sudo().has_group('odoo_marketplace.marketplace_officer_group'):
